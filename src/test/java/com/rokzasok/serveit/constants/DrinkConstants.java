...
public class DrinkConstants {
    ...
    public static final Drink NEW_ID_DRINK = new Drink(5, "12356", "Fanta", DrinkCategory.NON_ALCOHOLIC, "Nema", "Narandza, emulgatori", 35.0, "Bolja je Coca Cola", "via.placeholder.com/640x360", false);
